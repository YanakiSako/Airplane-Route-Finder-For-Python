...
class metarKeeper(threading.Thread):
    ...
    def run(self):
        while True:
            ...
            r=requests.get(f'https://tgftp.nws.noaa.gov/data/observations/metar/cycles/00Z.TXT',
           #r=requests.get(f'https://tgftp.nws.noaa.gov/data/observations/metar/cycles/{gmt_hr}Z.TXT', #byd我写炸了 6201帮我改下
